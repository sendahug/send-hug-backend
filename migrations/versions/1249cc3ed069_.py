...
def upgrade():
    ...
    op.add_column('users', sa.Column('release_date', sa.DateTime(),
                                     nullable=True))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('users', sa.Column('releaseDate', postgresql.TIMESTAMP(), autoincrement=False, nullable=True))
